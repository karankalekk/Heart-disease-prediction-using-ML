            ...
            <section class="glass">
                ...
                <div class="surguries">
                    <div class="status">
                        <h2>New Here!</h2>
                        <!-- Registeration Form -->
                        <form action="signin.php" method="POST" id="form" enctype="multipart/form-data">
                            <h4>Sign Up Now</h4>
                            <div class="form-group">
                                ...
                                <div class="icon-fix">
                                    ...
                                    <input type="text" name="name" class="form-control my-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter full name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">
                            ...
                            <div class="button-center text-center">
                                <!-- ............................................................................................... -->
                                <!-- <button type="submit" class="btn my-3"><a href="./signin.html">Sign Up</a></button> -->
                        ...
                        <hr>
                        <h4>Already have an account? <a href="./demo.html ">Log In</a></h4>
                    </div>
                </div>
            </section>
        </main>
